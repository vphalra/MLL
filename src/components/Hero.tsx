    ...
    <div className='hero-section min-h-[90vh] md:h-screen flex items-center justify-center px-4 py-16 md:py-0'>
      <div className='hero-content text-center text-white max-w-3xl mx-auto'>
        ...
        <p className='text-lg sm:text-xl mb-6 md:mb-8 opacity-90 max-w-2xl mx-auto'>
          MLL Service Inc. provides skilled labor solutions across manufacturing, agriculture, textile, chemical, and construction industries.
        </p>
        <div className='flex flex-col sm:flex-row justify-center gap-4 sm:gap-6'>
          <Link to="/request-services" className='bg-white text-black px-6 py-3 rounded-md font-medium hover:bg-opacity-90 transition-all w-full sm:w-auto text-center'>
            Request Services
          </Link>
